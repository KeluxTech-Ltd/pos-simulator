...
//    public void init() {
//
//        logger.info("The Fidelity Connection");
////        executors.submit(() -> connect());
////        executors.submit(() -> read());
//        logger.info("The Threeline Connection");
//        executors.submit(() -> threelineSwitchConfig.connect());
//        executors.submit(() -> threelineSwitchConfig.read());
//        logger.info("**********************POS HANDSHAKE**********************");
//        executors.submit(()->createSocketServer.createSocket());
//    }
//
