...
//
//                try {
//                    logger.info("Attempting connection to POS server {}:{}", posHost, posPort);
//                    this.socket.connect(new InetSocketAddress(posHost, posPort));
//                    logger.info("Connected to POS server {}:{}", posHost, posPort);
//                } catch (IOException e) {
//                    closeSocket();
//                    logger.error(String.format("Could not connect to POS remote %s:%d", posHost, posPort), e);
...
//
//            } catch (Exception e) {
//                logger.error("There was an error during POS connection", e);
//            }
//        }
//    }
//
...
//                } catch (IOException e) {
//                    closeSocket();
//                    logger.error("There was an error reading data from POS socket", e);
//                }
//            } catch (Exception e) {
//                logger.error("There as an error in POS read process", e);
//            }
//        }
//    }
//
...
//            socket.close();
//        } catch (IOException e) {
//            logger.error(String.format("There was an exception closing the POS client socket %s:%d", posHost, posPort), e);
//        } finally {
//            socket = null;
//            notifyDisconnect();
//        }
...
//        if (socket == null || !socket.isConnected()) {
//            throw new IOException("POS Socket is not connected");
//        }
//
//        String log = String.format("writing to %s:%d %d bytes%n%s", posHost, posPort, data.length, new String(data));
//        logger.info(log);
